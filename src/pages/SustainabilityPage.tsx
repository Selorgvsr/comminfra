...
const SustainabilityPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-green-500/5">
      ...
      <section className="esg_inquiry_portal_section py-20 relative overflow-hidden" style={{
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input placeholder="Company/Organization name" value={formData.organization} onChange={e => handleInputChange('organization', e.target.value)} />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea placeholder="Tell us about your sustainability goals and specific ESG requirements..." value={formData.message} onChange={e => handleInputChange('message', e.target.value)} rows={4} />
                </div>
