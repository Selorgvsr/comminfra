  ...
  const faqs = [
    {
      ...
      answer:
        "Carbon credits are calculated based on verified emission reductions compared to industry baselines. We work with certified agencies to measure, verify, and monetize carbon savings through accredited carbon markets, generating additional revenue streams for our properties.",
    },
    {
      question: "What ESG certifications do your properties achieve?",
      answer:
        "Our properties target LEED Gold/Platinum, BREEAM Excellent, and GRIHA 5-star certifications. We also pursue specialized certifications like WELL Building Standard for health and wellness, and are working towards net-zero carbon certifications.",
    },
    {
      question: "How do tenants benefit from solar power installations?",
      answer:
        "Tenants enjoy reduced electricity costs through our solar power sharing model. Depending on the lease structure, tenants can save 15-30% on energy costs while contributing to their own sustainability goals and corporate ESG commitments.",
    },
    {
      question: "What is the ROI on sustainability investments?",
      answer:
        "Sustainability features typically show 12-18% IRR through energy savings, carbon credit revenue, premium rents, and higher asset valuations. Green buildings also enjoy lower vacancy rates and attract ESG-focused tenants willing to pay premium rents.",
    },
  ];
                ...
                <div className="lg:w-1/2">
                  <Card className="overflow-hidden border-0 shadow-2xl group hover:shadow-3xl transition-all duration-500">
                    <div className="relative h-[400px] overflow-hidden">
                      ...
                      <div
                        className={`absolute top-6 right-6 w-20 h-20 rounded-2xl bg-gradient-to-br ${feature.color} backdrop-blur-md border border-white/20 flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300`}
                      >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {esgPillars.map((pillar, index) => (
              <Card
                key={index}
                className="esg_pillar_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-muted/20 backdrop-blur-sm"
              >
                <CardHeader className="text-center">
                  <div
                    className={`w-24 h-24 mx-auto rounded-2xl bg-gradient-to-br ${pillar.color} border border-primary/20 shadow-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {solarMetrics.map((metric, index) => (
              <Card
                key={index}
                className="solar_metric_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background/95 via-background/90 to-yellow-500/10 backdrop-blur-md"
              >
                <CardHeader className="text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {carbonCredits.map((credit, index) => (
              <Card
                key={index}
                className="carbon_credit_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-green-500/5 backdrop-blur-sm"
              >
                <CardHeader className="text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {advancedCapabilities.map((capability, index) => (
              <Card
                key={index}
                className="advanced_capability_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-purple-500/5 backdrop-blur-sm"
              >
                <CardHeader>
