...
const BusinessRevenueModelPage = () => {
  ...
  const revenueMetrics = [
    { label: "Total Portfolio Value", value: "₹450 Cr", growth: "+18%" },
    { label: "Annual Revenue", value: "₹85 Cr", growth: "+22%" },
    { label: "Average ROI", value: "14.2%", growth: "+3.1%" },
    { label: "ESG Revenue Share", value: "12%", growth: "+85%" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5">
      {/* Hero Section */}
      <section 
        className="revenue_model_hero_banner relative min-h-screen flex items-center justify-center overflow-hidden"
        style={{
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {sustainabilityStreams.map((stream, index) => (
              <Card key={index} className="sustainability_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-green-500/5 backdrop-blur-sm">
                <CardHeader>
      ...
      {/* Revenue Dashboard */}
      <section 
        className="revenue_dashboard_section py-20 relative overflow-hidden"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.9)), url(${sitePlanRevenue})`,
          backgroundSize: 'cover',
          backgroundPosition: 'center'
        }}
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Real-time metrics and projections across all revenue streams
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {revenueMetrics.map((metric, index) => (
              <Card key={index} className="metric_card border-0 bg-gradient-to-br from-background/95 via-background/90 to-primary/5 backdrop-blur-md shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="border-0 bg-gradient-to-br from-background/95 via-background/90 to-primary/5 backdrop-blur-md shadow-xl">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm">ESG Revenue</span>
            ...
            <Card className="border-0 bg-gradient-to-br from-background/95 via-background/90 to-green-500/5 backdrop-blur-md shadow-xl">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-950/20 rounded-lg">
                  ...
                  <span className="text-sm font-bold text-green-600">500 tons/year</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                  <span className="text-sm font-medium">Solar Generation</span>
                  <span className="text-sm font-bold text-blue-600">1,200 MW/year</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-purple-50 dark:bg-purple-950/20 rounded-lg">
                  <span className="text-sm font-medium">ESG Rating</span>
                  <span className="text-sm font-bold text-purple-600">A+ Grade</span>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section 
        className="investor_inquiry_section py-20 relative overflow-hidden"
        style={{
            ...
            <Card className="border-0 bg-gradient-to-br from-background/95 via-background/90 to-primary/5 backdrop-blur-md shadow-2xl">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    placeholder="Tell us about your investment goals, timeline, and any specific questions about our revenue model..."
