  ...
  const faqs = [
    {
      ...
      answer:
        "Standard lease packages include HVAC systems, fire safety equipment, power backup, water supply, basic security systems, and common area maintenance. Parking allocation and waste management services are also included.",
    },
    {
      question: "Can I customize interiors?",
      answer:
        "Yes, we offer flexible interior customization options. Tenants can modify layouts, install branding elements, upgrade lighting systems, and add specialized equipment based on their business needs, subject to building regulations.",
    },
    {
      question: "What's the process for site visits and approvals?",
      answer:
        "Schedule a site visit through our portal, complete the tenant application form, provide business documentation, undergo credit verification, and receive lease approval within 5-7 business days.",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5">
      ...
      <section className="rent_lease_hero_banner relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={leasedRetailInterior}
            alt="Rent or Lease Commercial Properties"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {leaseModels.map((model, index) => (
              <Card
                key={index}
                className="lease_model_card h-full hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-secondary/5 backdrop-blur-sm overflow-hidden"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {facilities.map((facility, index) => (
              <Card
                key={index}
                className="facility_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-primary/5 via-secondary/10 to-accent/5 backdrop-blur-sm"
              >
                <CardHeader className="text-center">
                  <div
                    className={`w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br ${facility.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {esgFeatures.map((feature, index) => (
              <Card
                key={index}
                className="esg_feature_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-green-500/5 backdrop-blur-sm"
              >
                <CardHeader className="text-center">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredListings.map((listing, index) => (
              <Card
                key={index}
                className="listing_card group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 bg-gradient-to-br from-background via-background/90 to-primary/5 backdrop-blur-sm overflow-hidden"
              >
                  ...
                  <img
                    src={
                      index === 0
                        ? retailFloorInterior
                        : index === 1
                          ? restaurantCommercialInterior
                          : smartInfrastructureBlueprint
                    }
                    alt={listing.title}
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
